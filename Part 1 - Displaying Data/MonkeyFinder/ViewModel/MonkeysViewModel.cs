...
public partial class MonkeysViewModel : BaseViewModel
{
    ...
    async Task GetClosestMonkey()
    {
        ...
        {
            Debug.WriteLine(ex);
            await Shell.Current.DisplayAlert("Error!", ex.Message, "Unable to get closest monkey: {ex.Message}", "OK");
        }
    }
    ...
    async Task GetMonkeyAsync()
    {
        ...
        {
            Debug.WriteLine(ex);
            await Shell.Current.DisplayAlert("Error!", ex.Message, "Unable to get monkeys: {ex.Message}", "OK");
        }
        finally
        {
            IsBusy = false;
